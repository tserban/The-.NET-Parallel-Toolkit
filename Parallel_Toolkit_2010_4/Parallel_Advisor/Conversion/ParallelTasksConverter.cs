...
namespace Parallel_Advisor.Conversion
{
    public class ParallelTasksConverter : TasksPragmaScanner, IConverter
    {
        ...
        private void ConvertTasks(string[] codeLines, string outputFile)
        {
            ...
            if (isPooled)
            {
                codeBefore =
                    ...
                    codeAfter +=
                        indent + "int CPUS" + tasksIndex + " = Environment.ProcessorCount;\r\n" +
                        indent + "int TASKS" + tasksIndex + " = CPUS" + tasksIndex + ";\r\n" +
                        indent + "int CURRENT_TASK" + tasksIndex + " = -1;\r\n" +
                        indent + "System.Threading.Thread[] THREADS" + tasksIndex + " = new System.Threading.Thread[CPUS" + tasksIndex + "];\r\n" +
                        indent + "for (int TID" + tasksIndex + " = 0; TID" + tasksIndex + " < CPUS" + tasksIndex + "; TID" + tasksIndex + "++)\r\n" +
                        indent + "{\r\n" +
                        indent + "    THREADS" + tasksIndex + "[TID" + tasksIndex + "] = new System.Threading.Thread(\r\n" +
                        indent + "        PARAM" + tasksIndex + " =>\r\n" +
                        indent + "        {\r\n" +
                        indent + "            while(System.Threading.Interlocked.Increment(ref CURRENT_TASK" + tasksIndex + ") < TASKCOUNT" + tasksIndex + ")\r\n" +
                        indent + "            {\r\n" +
                        indent + "                TASKLIST" + tasksIndex + "[CURRENT_TASK" + tasksIndex + "](null);\r\n" +
                        indent + "            }\r\n" +
                        indent + "        });\r\n" +
                        indent + "    THREADS" + tasksIndex + "[TID" + tasksIndex + "].Start();\r\n" +
                        indent + "}\r\n\r\n";
                ...
                if(!noSyncOn)
                {
                    codeAfter +=
                        indent + "for (int TID" + tasksIndex + " = 0; TID" + tasksIndex + " < CPUS" + tasksIndex + "; TID" + tasksIndex + "++)\r\n" +
                        indent + "{\r\n" +
                        indent + "    THREADS" + tasksIndex + "[TID" + tasksIndex + "].Join();\r\n" +
                        indent + "}\r\n\r\n";
                }
            }
            else
            {
                codeBefore =
                     indent + "int TASKCOUNT" + tasksIndex + " = " + currentTask + ";\r\n" +
                     indent + "System.Threading.ParameterizedThreadStart[] TASKLIST" + tasksIndex + " = new System.Threading.ParameterizedThreadStart[TASKCOUNT" + tasksIndex + "];\r\n" +
                     indent + "bool[] SYNCLIST" + tasksIndex + " = new bool[TASKCOUNT" + tasksIndex + "];\r\n\r\n";


                codeAfter +=
                     indent + "System.Threading.Thread[] THREADS" + tasksIndex + " = new System.Threading.Thread[TASKCOUNT" + tasksIndex + "];\r\n" +
                     indent + "for(int TID" + tasksIndex + " = 0; TID" + tasksIndex + " < TASKCOUNT" + tasksIndex + "; TID" + tasksIndex + "++)\r\n" +
                     indent + "{\r\n" +
                     indent + "    THREADS" + tasksIndex + "[TID" + tasksIndex + "] = new System.Threading.Thread(TASKLIST" + tasksIndex + "[TID" + tasksIndex + "]);\r\n" +
                     indent + "    THREADS" + tasksIndex + "[TID" + tasksIndex + "].Start();\r\n" +
                     indent + "}\r\n\r\n";
                ...
                if(!noSyncOn)
                {
                    codeAfter +=
                         indent + "for(int TID" + tasksIndex + " = 0; TID" + tasksIndex + " < TASKCOUNT" + tasksIndex + "; TID" + tasksIndex + "++)\r\n" +
                         indent + "{\r\n" +
                         indent + "    if(SYNCLIST" + tasksIndex + "[TID" + tasksIndex + "] == true)\r\n" +
                         indent + "    {\r\n" +
                         indent + "        THREADS" + tasksIndex + "[TID" + tasksIndex + "].Join();\r\n" +
                         indent + "    }\r\n" +
                         indent + "}\r\n\r\n";
        ...
        private void ConvertTask(string[] codeLines, string outputFile)
        {
            ...
            {
                codeAfter = 
                    indent + "SYNCLIST" + tempIndex +"[" + currentTask + "] = true;\r\n";
            }
